  ...
  return (
    ...
    <>
      ...
      <div className='login bg-black h-screen flex items-center'>
        <div className="log  w-1/2 flex items-center justify-center">
        ...
        <div className="right text-white m-4">
          <h2 className='text-6xl font-bold'>Happening now</h2>
          <div className='font-bold text-4xl mt-6 ml-32'>{isLogin ? "Sing in" : "Login"}</div>
          <form className='flex flex-col  bg-[#000000cf] text-white relative px-14 pt-8 gap-3  rounded-lg' action=""
          ...
          <div className='mt-2 ml-32'>{isLogin ? "Do not have account?" : "Already have a account!"} <span onClick={() => { setisLogin(!isLogin) }} className='text-blue-600 hover:underline cursor-pointer'>{isLogin ? "Sing in" : "Login"}</span> </div>
        </div>
