...
const LeftSideBar = () => {
    ...
    return (
        <div className='sidebar  flex flex-col items-end sm:sticky sm:top-3 bottom-0 sm:min-h-screen'>
            <div className="logo sm:w-[55%] w-screen  flex sm:flex-col xl:flex-row sm:justify-center justify-evenly sm:gap-4 xl:gap-14 sm:h-full h-12  sm:static fixed top-0 left-0 ">
            ...
            <ul className="flex m-auto sm:mt-3 sm:h-full h-12 items-center sm:items-start  sm:flex-col sm:gap-2 mt-4 xl:mr-5 text-xl sm:static fixed bottom-0 right-0 justify-evenly sm:justify-normal min-w-fit w-full sm:w-fit sm:m-0 ">
                {
                    components.map((item) => {
                        return (
